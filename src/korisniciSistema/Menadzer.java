...
public class Menadzer extends Zaposlen {
	...
	public Menadzer(String korisnickoIme, String lozinka, String ime, String prezime, String pol, String telefon, String adresa, 
	...
	public String toString() {
		return "Menadzer [korisnicko_ime=" + getKorisnickoIme() + ", lozinka=" + getLozinka() + ", ime=" + getIme() + ", prezime=" + getPrezime() + 
