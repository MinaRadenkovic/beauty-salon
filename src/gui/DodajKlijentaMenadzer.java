...
public class DodajKlijentaMenadzer extends JDialog {
	...
	public DodajKlijentaMenadzer(JTable tabela) {
		...
		JLabel lblNewLabel = new JLabel("REGISTRACIJA KLIJENTA");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel.setBounds(125, 10, 217, 17);
