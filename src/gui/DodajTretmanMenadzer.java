...
public class DodajTretmanMenadzer extends JDialog {
	...
	public DodajTretmanMenadzer(JTable tabela) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(DodajTretmanMenadzer.class.getResource("/gui/BeautySalon.png")));
		setTitle("SV76-2022");
		...
		{
			JLabel lblNewLabel = new JLabel("Dodavanje novog tretmana: ");
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if (textField_1.getText() != null && textField_2.getText() != null && textField_3.getText() != null && choice.getSelectedItem() != null) {
							...
							tretmanCRUD.add(nazivUsluge, nazivTretmana, vremeTrajanja, cena);
